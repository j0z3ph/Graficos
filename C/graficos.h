 ...
 */
extern void imprimeEnConsola(const char *msj);
 ...
 */
extern void pantallaCompleta(bool fs);
 ...
 * @param b Azul (0-255)
 */
extern void colorFondoRGB(UINT8 r, UINT8 g, UINT8 b);
 ...
 */
extern Imagen *creaImagen(const char *ruta);
 ...
 * posible cargar la imagen.
 */
extern Imagen *creaImagenConMascara(const char *ruta, const char *ruta_mascara);
 ...
 */
extern void eliminaImagen(Imagen *imagen);
 ...
 */
extern void muestraImagen(int x, int y, const Imagen *imagen);
 ...
 * @param imagen Imagen a mostrar
 */
extern void muestraImagenEscalada(int x, int y, int ancho, int alto, const Imagen *imagen);
/**
 ...
 */
extern int altoImagen(const Imagen *imagen);
/**
 ...
 */
extern int anchoImagen(const Imagen *imagen);
 ...
 */
extern void texto1(int x, int y, const char *texto, int tamanioFuente, const char *fuente);
 ...
 */
extern void texto2(int x, int y, const char *texto, int tamanioFuente, const char *fuente,
 ...
 */
extern void muestraMensaje1(const char *msj, const char *titulo);
/**
 ...
 */
extern bool muestraPregunta(const char *msj);
/**
 * @brief Muestra un dialogo de pregunta.
 *
 * @param msj Mensaje que se mostrara en el dialogo.
 ...
 * @return false En cualquier otro caso.
 */
extern bool muestraPregunta1(const char *msj, const char *titulo);
/**
 ...
 */
extern void espera(int miliseg);
 ...
 */
extern void colorRGB(UINT8 r, UINT8 g, UINT8 b);
 ...
 */
extern void linea(int x1, int y1, int x2, int y2);
/**
 ...
 */
extern void rectangulo(int x1, int y1, int x2, int y2);
/**
 ...
 * @param y2 Coordenada y de la esquina inferior derecha.
 */
extern void rectanguloRelleno(int x1, int y1, int x2, int y2);
/**
 ...
 */
extern void circulo(int x, int y, int radio);
/**
 ...
 * @param radio Radio del circulo.
 */
extern void circuloRelleno(int x, int y, int radio);
/**
 ...
 */
extern void texto(int x, int y, const char *texto);
 ...
 */
extern void ratonBotones(bool *izq, bool *der);
/**
 ...
 */
extern bool ratonBotonIzquierdo();
/**
